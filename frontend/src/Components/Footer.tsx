    ...
    <section className="pt-12 pb-5 md:pt-16 md:pb-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-600 text-sm">
              Your trusted source for authentic badminton equipment. Quality
              products, expert service, and fast delivery.
            </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-normal text-sm">About Us</p>
            <p className="font-normal text-sm">Shipping & Returns</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-normal text-sm">123 Badminton Street</p>
            <p className="font-normal text-sm">Ho Chi Minh City, Vietnam</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-row gap-2">
              ...
              />
              <button className="text-sm h-10 px-4 rounded-r-lg bg-black text-white font-medium hover:bg-gray-800 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-row justify-center gap-1 mt-10 border-t border-gray-200 pt-6">
          ...
          <p className="text-sm">
            2025 N&B Badminton Shop. All rights reserved.
          </p>
        </div>
      </div>
    </section>
