...
const ProductCustomerController_1 = require("../controllers/ProductCustomerController");
const router = express_1.default.Router();
// Resolve dependency
const productCustomerController = tsyringe_1.container.resolve(ProductCustomerController_1.ProductCustomerController);
...
router.get("/category/:categoryId", productCustomerController.getProductsByCategory);
...
router.get("/category/:categoryId/variations", productCustomerController.getVariationsByCategory);
