...
exports.vietqrConfig = void 0;
exports.createVietQRCode = createVietQRCode;
exports.createVietQRData = createVietQRData;
exports.getBankName = getBankName;
require("dotenv").config();
exports.vietqrConfig = {
 ...
 */
function createVietQRCode(amount, message = "") {
    if (!exports.vietqrConfig.bankCode || !exports.vietqrConfig.accountNumber) {
        throw new Error("VietQR configuration is missing. Please check VIETQR_BANK_CODE and VIETQR_ACCOUNT_NUMBER in .env file");
    }
    ...
    const qrUrl = `https://img.vietqr.io/image/${exports.vietqrConfig.bankCode}-${exports.vietqrConfig.accountNumber}-${exports.vietqrConfig.template}.png?amount=${Math.round(amount)}&addInfo=${encodeURIComponent(cleanMessage)}`;
    return qrUrl;
}
/**
 ...
 */
function createVietQRData(amount, message = "") {
    if (!exports.vietqrConfig.bankCode || !exports.vietqrConfig.accountNumber) {
        throw new Error("VietQR configuration is missing. Please check VIETQR_BANK_CODE and VIETQR_ACCOUNT_NUMBER in .env file");
    }
    // Format message
    ...
    return `https://img.vietqr.io/image/${exports.vietqrConfig.bankCode}-${exports.vietqrConfig.accountNumber}-${exports.vietqrConfig.template}.png?amount=${Math.round(amount)}&addInfo=${encodeURIComponent(cleanMessage)}`;
}
/**
